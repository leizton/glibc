...
#define atomic_compare_and_exchange_bool_acq(mem, newval, oldval) \
  __atomic_bool_bysize(__arch_compare_and_exchange_bool, acq, mem, newval, oldval)
#else
#define atomic_compare_and_exchange_bool_acq(mem, newval, oldval)                \
  ({ /* Cannot use __oldval here, because macros later in this file might        \
  call this macro with __oldval argument.	 */                                    \
     __typeof(oldval) __atg3_old = (oldval);                                     \
     atomic_compare_and_exchange_val_acq(mem, newval, __atg3_old) != __atg3_old; \
  })
#endif
#endif
...
#define catomic_compare_and_exchange_bool_acq(mem, newval, oldval)                \
  ...
  call this macro with __oldval argument.	 */                                     \
     ...
     catomic_compare_and_exchange_val_acq(mem, newval, __atg4_old) != __atg4_old; \
  })
#endif
#endif
  ...
  do {                                                                                        \
    ...
    do {                                                                                      \
      ...
      if (__atg8_oldval >= __atg8_value)                                                      \
        break;                                                                                \
    } while (__builtin_expect(atomic_compare_and_exchange_bool_acq(__atg8_memp, __atg8_value, \
                                                                   __atg8_oldval),            \
                              0));                                                            \
  } while (0)
#endif
  ...
  do {                                                                            \
    ...
    do {                                                                          \
      ...
      if (__atg9_oldv >= __atg9_value)                                            \
        break;                                                                    \
    } while (__builtin_expect(catomic_compare_and_exchange_bool_acq(__atg9_memp,  \
                                                                    __atg9_value, \
                                                                    __atg9_oldv), \
                              0));                                                \
  } while (0)
  ...
  do {                                                                              \
    ...
    do {                                                                            \
      ...
      if (__atg10_oldval <= __atg10_value)                                          \
        break;                                                                      \
    } while (__builtin_expect(atomic_compare_and_exchange_bool_acq(__atg10_memp,    \
                                                                   __atg10_value,   \
                                                                   __atg10_oldval), \
                              0));                                                  \
  } while (0)
...
#define atomic_and(mem, mask)                                                                \
  do {                                                                                       \
    ...
    while (__builtin_expect(atomic_compare_and_exchange_bool_acq(__atg15_memp,               \
...
#define catomic_and(mem, mask)                                                                \
  do {                                                                                        \
    ...
    while (__builtin_expect(catomic_compare_and_exchange_bool_acq(__atg20_memp,               \
...
#define atomic_or(mem, mask)                                                                 \
  do {                                                                                       \
    ...
    while (__builtin_expect(atomic_compare_and_exchange_bool_acq(__atg17_memp,               \
...
#define catomic_or(mem, mask)                                                                 \
  do {                                                                                        \
    ...
    while (__builtin_expect(catomic_compare_and_exchange_bool_acq(__atg18_memp,               \
...
#define __atomic_check_size_ls(mem)                                                             \
  if ((sizeof(*mem) != 1) && (sizeof(*mem) != 2) && (sizeof(*mem) != 4) && (sizeof(*mem) != 8)) \
    __atomic_link_error();
#else
#define __atomic_check_size_ls(mem)                                    \
