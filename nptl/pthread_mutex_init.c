...
int __pthread_mutex_init(pthread_mutex_t* mutex,
  ...
  /* Sanity checks.  */
  switch (__builtin_expect(imutexattr->mutexkind & PTHREAD_MUTEXATTR_PROTOCOL_MASK,
                           PTHREAD_PRIO_NONE
  ...
  if ((imutexattr->mutexkind & PTHREAD_MUTEXATTR_FLAG_ROBUST) != 0) {
    ...
    if ((imutexattr->mutexkind & PTHREAD_MUTEXATTR_FLAG_PSHARED) != 0 && __set_robust_list_avail < 0)
      return ENOTSUP;
#endif
  ...
  case PTHREAD_PRIO_PROTECT << PTHREAD_MUTEXATTR_PROTOCOL_SHIFT:
    ...
    int ceiling = (imutexattr->mutexkind & PTHREAD_MUTEXATTR_PRIO_CEILING_MASK) >> PTHREAD_MUTEXATTR_PRIO_CEILING_SHIFT;
    if (!ceiling) {
  ...
  if ((imutexattr->mutexkind & (PTHREAD_MUTEXATTR_FLAG_PSHARED | PTHREAD_MUTEXATTR_FLAG_ROBUST)) != 0)
